  ...
  banners: [
    {
      ...
      focusHeroes: ["Shez (Legendary Heroes)", "Myrrh (Legendary Heroes)", "Lilina (Legendary Heroes)", "Ninian (Legendary Heroes)","Claude (Legendary Heroes)", "Medeus", "Byleth (F) (Weave of Fate)", "Seliph (Weave of Fate)", "Chrom (Weave of Fate)", "Tiki (Weave of Fate)", "Seiðr"],
      excludeFromRarity4: [],
      excludeFromRarity5: [],
    ...
    banners: [
      {
        ...
        focusHeroes: ["Elimine", "Askr", "Letizia", "Otr", "Eitri", "Sain", "Est (Ymir & More)", "Chrom (Legendary Heroes)", "Líf", "Mirabilis", "Plumeria", "Arval"],
        excludeFromRarity4: [],
        excludeFromRarity5: [],
        rateType: "legendaryV2",
        pool: "pool6"
